<?php
    ...
    if(!empty($_POST))
    {
        ...
        fwrite($file, $email."\n");
        fclose($file);
        // aantal entries uitlezen
        $counter = count(file("mailinglist.txt"));
    	$feedback = "You're subscriber number $counter";
    }
...
<div id="container">
	<h1>
		...
		{
			echo "The IMD Convoy App is coming to a classroom near you soon.";
		} ?>
		</h1>
